...
DEPLOYMENT_SPACE_ID = #YOUR Deployment Space ID#
## ID of the deployement
DEPLOYMENT_ID = #Your Deployment ID, Copy and paste the output after running deployment-model.py"
## ID of the deployed model
MOLDE_UID = #Your Molde UID, Copy and paste the output after running deployment-model.py"
...
def load_wml_credentials():
    ...
    wmlcreds_dir = ##YOUR WML.JSON File Path #os.path.join(os.getcwd(),"ibm")
